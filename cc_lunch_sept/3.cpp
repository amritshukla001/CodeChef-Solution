...
void solve() {
	...
	while (n != 1 and n != 2) {
		...
		//wi(n);
		//cout << turn.fr << " " << turn.sc << "\n";
	}

	if (n == 1 and turn.sc == 'a') cout << "Bob\n";
	else if (n == 1 and turn.sc == 'b') cout << "Alice\n";
	else if (n == 2 and turn.sc == 'a') cout << "Bob\n";
	else if (n == 2 and turn.sc == 'b') cout << "Alice\n";
}
