...
void solve() {
	...
	//Case 1: 1st op is never applied
	cout << cnt2(a, b) << "\n";

	//Case 2: 1st op is applied for the first time
	int nta = a, ntb = b;

	nta = ntb = sqrtSearch(0, a * b, a * b);

	cout << sqrtSearch(0, 70 * 141, 70 * 141) << "\n";
	wi2(nta, ntb);
